 ...
 */
@Timeout(10)
class ProvoneDslTest extends Dsl2Spec{
    ...
    def 'should perform a hi and create a channel' () {
        when:
        def SCRIPT = '''
            include {reverse} from 'plugin/nf-provone'
            channel.reverse('hi!') 
            '''
        and:
    ...
    def 'should store a goodbye' () {
        when:
        def SCRIPT = '''
            include {goodbye} from 'plugin/nf-provone'
            channel
                .of('folks')
                .goodbye() 
            '''
    ...
    def 'can use an imported function' () {
        when:
        def SCRIPT = '''
            include {randomString} from 'plugin/nf-provone'
            channel
                .of( randomString(20) )                
            '''
        and:
